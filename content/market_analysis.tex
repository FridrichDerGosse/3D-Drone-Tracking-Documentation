...
% todo: maybe shorten this by not explaining the key factors in detail and just listing them?
\begin{itemize} 
...
\begin{itemize} 
	...
	\item \textbf{High Initial Costs:} The expense of acquiring and maintaining advanced drones may be prohibitive for small-scale farmers. % todo: source
...
Opportunities to address these challenges include: % todo: think of this section as we don't really use these opportunities (only in theory)
% maybe rewrite like we could use government support later and include privacy featuares in our drones. 
% point with cost-efficiencly is good but doesn't fully align with the challenges listed above
...
\begin{itemize} 
	...
	\item \textbf{Technological Innovations:} Developing user-friendly and cost-effective drones can lower barriers to entry \citep{guardianagriculture}. % todo: weak source for this claim, maybe write without source
