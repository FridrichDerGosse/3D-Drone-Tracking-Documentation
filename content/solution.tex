...
The chosen power supply was a PD 100W, 20,000mAh power bank from POWERADD PRO \cite{poweradd_pro_powerbank} with three \acrfull{usb} ports. This model met the project's technical requirements as follows:
\begin{itemize}
...
% todo: comparison image of old and new 
...
% todo: write in numbers of used components and ref to image

% todo: insert image of gear mechanism here
...
% todo: ref to image of tof laser as camera is visible
...
% todo: have great image of soldered pcb. maybe put this somewhere else and use the other one or both? one for pcb and one for connection?
...
% todo: somewhere here include the rendering of the first housing (subtodo: research where to put images, infront of explanation or behind)
...
% todo: all of below is visible in the open station image. use it
...
% todo: was already shown in image before, that showcased other. but here also possible to use one of the images of all stations (behind image)
...
% todo: great section for end picture?
...
\begin{wrapfigure}[31]{r}{0.5\textwidth}
	...
	\source{Own illustration created with draw.io \cite{drawio}}
