...
\newcommand{\mytitle}{3D Object Tracking} 
\newcommand{\mysubtitle}{Image-Based 3D Tracking with Multiple Stations}
\newcommand{\myinstitute}{Department of Electronics and Computer Engineering} 
\newcommand{\mysubmissionyear}{2025} %% Einreich - Jahr
\newcommand{\mysubmissionmonth}{...} %% Monat der Einreichung
...
\input{content/market_analysis} % Einfach auskommentieren für die tatsächliche Arbeit
